...
`cloud-itonami-iso3166-cyp` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Cyprus-licensed counsel or a registered agent for whatever licensed
representation the law of the Republic of Cyprus requires for
