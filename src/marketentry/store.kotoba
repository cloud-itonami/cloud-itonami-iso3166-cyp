(ns marketentry.store
  "SSoT for the Republic of Cyprus (CYP) market-entry compliance actor,
...
(defn demo-data
  ...
  `:exclusion-ground?` / `:invokes-self-cleaning?` /
  `:compensation-paid-or-committed?` / `:facts-clarified-cooperated?` /
  `:remedial-measures-taken?` / `:excluded-by-final-decision?` /
  `:within-exclusion-period?` are ground truth for the `self-cleaning-
  claim-unsupported` flagship check (Ν. 73(Ι)/2016, Article 57(6)-(7),
  'self-cleaning'); `:requires-tax-record?` / `:tax-record-verified?`
  are ground truth for the conditional Tax Department/Tax Portal check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Lefkosia Fabrication Ltd" :portal "eprocurement.gov.cy/epps"
             ...
             :compensation-paid-or-committed? false :facts-clarified-cooperated? false :remedial-measures-taken? false
             ...
             :jurisdiction "CYP" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "eprocurement.gov.cy/epps"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :exclusion-ground? false :invokes-self-cleaning? false
             :compensation-paid-or-committed? false :facts-clarified-cooperated? false :remedial-measures-taken? false
    ...
    "eng-3" {:id "eng-3" :operator "Limassol Systems Ltd" :portal "eprocurement.gov.cy/epps"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "CYP" :status :intake}
    "eng-4" {:id "eng-4" :operator "Paphos Construction Ltd" :portal "eprocurement.gov.cy/epps"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :exclusion-ground? true :invokes-self-cleaning? true
             :compensation-paid-or-committed? true :facts-clarified-cooperated? true :remedial-measures-taken? false
             :excluded-by-final-decision? false :within-exclusion-period? false
             :requires-tax-record? true :tax-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "CYP" :status :intake}
    "eng-5" {:id "eng-5" :operator "Larnaca Logistics Ltd" :portal "eprocurement.gov.cy/epps"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :exclusion-ground? false :invokes-self-cleaning? false
             :compensation-paid-or-committed? false :facts-clarified-cooperated? false :remedial-measures-taken? false
             :excluded-by-final-decision? false :within-exclusion-period? false
             :requires-tax-record? true :tax-record-verified? false
             :drafted? false :submitted? false
             :jurisdiction "CYP" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               ...
                               excluded-by-final-decision? within-exclusion-period?
                               requires-tax-record? tax-record-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? exclusion-ground?)             (assoc :engagement/exclusion-ground? exclusion-ground?)
    (some? invokes-self-cleaning?)        (assoc :engagement/invokes-self-cleaning? invokes-self-cleaning?)
    (some? compensation-paid-or-committed?) (assoc :engagement/compensation-paid-or-committed? compensation-paid-or-committed?)
    (some? facts-clarified-cooperated?)   (assoc :engagement/facts-clarified-cooperated? facts-clarified-cooperated?)
    (some? remedial-measures-taken?)      (assoc :engagement/remedial-measures-taken? remedial-measures-taken?)
    (some? excluded-by-final-decision?)   (assoc :engagement/excluded-by-final-decision? excluded-by-final-decision?)
    (some? within-exclusion-period?)      (assoc :engagement/within-exclusion-period? within-exclusion-period?)
    (some? requires-tax-record?)          (assoc :engagement/requires-tax-record? requires-tax-record?)
    (some? tax-record-verified?)          (assoc :engagement/tax-record-verified? tax-record-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/exclusion-ground? :engagement/invokes-self-cleaning?
   :engagement/compensation-paid-or-committed? :engagement/facts-clarified-cooperated? :engagement/remedial-measures-taken?
   :engagement/excluded-by-final-decision? :engagement/within-exclusion-period?
   :engagement/requires-tax-record? :engagement/tax-record-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :exclusion-ground? (boolean (:engagement/exclusion-ground? m))
     :invokes-self-cleaning? (boolean (:engagement/invokes-self-cleaning? m))
     :compensation-paid-or-committed? (boolean (:engagement/compensation-paid-or-committed? m))
     :facts-clarified-cooperated? (boolean (:engagement/facts-clarified-cooperated? m))
     :remedial-measures-taken? (boolean (:engagement/remedial-measures-taken? m))
     :excluded-by-final-decision? (boolean (:engagement/excluded-by-final-decision? m))
     :within-exclusion-period? (boolean (:engagement/within-exclusion-period? m))
     :requires-tax-record? (boolean (:engagement/requires-tax-record? m))
     :tax-record-verified? (boolean (:engagement/tax-record-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-cyp"})
