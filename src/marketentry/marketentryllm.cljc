(ns marketentry.marketentryllm
  ...
  the Republic of Cyprus (CYP) public-sector market-entry compliance
  actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "exclusion-ground?=" (:exclusion-ground? e)
                        " invokes-self-cleaning?=" (:invokes-self-cleaning? e)
                        " compensation-paid-or-committed?=" (:compensation-paid-or-committed? e)
                        " facts-clarified-cooperated?=" (:facts-clarified-cooperated? e)
                        " remedial-measures-taken?=" (:remedial-measures-taken? e)
                        " tax-record-verified?=" (:tax-record-verified? e)
     ...
     :confidence (if (and e
                          (or (not (:requires-tax-record? e))
                              (:tax-record-verified? e)))
                   0.9 0.3)}))
